...
export const translations = {
  cs: {
    ...
    contact: {
      ...
      hoursData: [
        { day: "Po – Pá", time: "9:00 – 19:00" },
        { day: "Sobota", time: "9:00 – 19:00" },
        { day: "Neděle", time: "10:00 – 17:00" },
      ],
      messageBtn: "Napište nám na Facebook",
    ...
    form: {
      ...
      submit: "Rezervovat přes Messenger",
      submitting: "Otvírám Messenger…",
  ...
  en: {
    ...
    contact: {
      ...
      messageBtn: "Message on Facebook",
    ...
    form: {
      ...
      submit: "Book via Messenger",
      submitting: "Opening Messenger…",
